    ...
    <div class="flex justify-between items-end">
      <div>
        ...
        <p class="text-text-secondary mt-1">
          Selecione documentos indexados, escreva o prompt pedagógico e gere um
          rascunho de perguntas para revisão.
        </p>
      </div>
      <button
        @click="submitPrompt"
      ...
      >
        <i v-if="questionLabStore.isLoading" class="pi pi-spin pi-spinner"></i>
      ...
      <section class="col-span-8 space-y-5">
        ...
        >
          ...
          <div class="space-y-3">
            ...
            >
              Ainda não existem rascunhos. Envie um prompt para gerar o primeiro
              bloco de perguntas via LLM.
            </div>
          </div>
        </article>
      </section>
...
const disciplineDocuments = computed(() =>
  questionLabStore.availableDocuments.filter(
    (d) => d.discipline === form.discipline && d.status === 'indexed',
  ),
);
